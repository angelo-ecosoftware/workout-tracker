      ...
      try {
        ...
        if (profile) {
          ...
          const resolvedMetrics: UserMetrics = {
            ...
            goals: profile.goals?.length ? profile.goals : profile.metrics?.goals,
            somatotype: profile.metrics?.somatotype,
            trainingDays: profile.trainingDays?.length ? profile.trainingDays : profile.metrics?.trainingDays,
