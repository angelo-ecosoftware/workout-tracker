...
export const AssistedTimedTracker: React.FC<AssistedTimedTrackerProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {phase === 'resting' && (
        <div className="bg-[#0c0c0c] border border-[#222] rounded-[32px] p-8 sm:p-12 text-center flex flex-col items-center justify-center space-y-6 shadow-2xl animate-in zoom-in-95 duration-200 min-h-[420px]">
          ...
          <div className="pt-2">
            <button
              ...
              className="inline-flex items-center gap-2 px-7 py-3 bg-[#181818] hover:bg-[#242424] border border-[#333] hover:border-[#C0FF00]/50 rounded-2xl text-xs font-mono font-bold text-white uppercase tracking-wider transition-all cursor-pointer shadow-lg"
            >
      ...
      {(phase === 'ready' || phase === 'in_progress') && currentExercise && currentValues && (
        <div className="bg-[#111111] border border-[#2a2a2a] rounded-[28px] p-6 sm:p-8 space-y-6 shadow-2xl relative overflow-hidden">
          
          {/* Top exercise title & target */}
          <div className="flex items-start justify-between gap-3 border-b border-[#222] pb-5">
            <div>
              <div className="flex items-center gap-2.5">
                <span className="w-7 h-7 rounded-lg bg-[#C0FF00] text-black font-display font-black text-xs flex items-center justify-center shrink-0">
                  {exerciseIndex + 1}
                </span>
                <h3 className="font-display font-black italic text-xl sm:text-2xl text-white uppercase tracking-tight">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-[#181818] hover:bg-[#222] border border-[#333] rounded-xl text-[11px] font-mono text-gray-300 flex items-center gap-1.5 cursor-pointer shrink-0"
            >
          ...
          {/* Guide Dropdown */}
          {showWgerInfo && (
            <div className="p-4 bg-[#161616] border border-[#262626] rounded-2xl">
              <WgerExerciseInfo exerciseName={currentExercise.name} />
            </div>
          )}

          {/* Active Set Box */}
          <div className="bg-[#161616] border border-[#2e2e2e] rounded-2xl p-5 sm:p-6 space-y-5">
            <div className="flex items-center justify-between border-b border-[#242424] pb-3.5">
              <span className="font-display font-black italic text-base text-[#C0FF00] uppercase tracking-wider">
                SET {setNumber} OF {currentExercise.targetSets}
              </span>
              {phase === 'in_progress' && (
                <span className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 text-[10px] font-mono font-bold animate-pulse">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      className="px-3.5 py-2.5 bg-[#222] border border-[#333] hover:border-[#C0FF00]/40 rounded-xl text-white font-mono text-xs cursor-pointer"
                    >
                      -5s
                    </button>
                    <input
                      ...
                      className="flex-1 bg-[#111] border border-[#333] focus:border-[#C0FF00] rounded-xl py-2.5 text-center font-mono font-black text-white text-base focus:outline-none"
                      placeholder="Sec"
                    />
                    <button
                      type="button"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <input
                      ...
                      className="flex-1 bg-[#111] border border-[#333] focus:border-[#C0FF00] rounded-xl py-2.5 text-center font-mono font-black text-[#C0FF00] text-base focus:outline-none"
                    />
                    <button
                      type="button"
                      onClick={() => onUpdateInput(currentSetKey, 'difficulty', 1)}
          ...
          <div className="flex items-center justify-between gap-3 pt-2">
            <button
              ...
              className="px-5 py-4 bg-[#181818] hover:bg-[#202020] border border-[#333] rounded-2xl text-xs font-mono font-bold text-gray-400 hover:text-white transition-colors cursor-pointer"
            >
              Skip Set (0)
            </button>
            ...
            {phase === 'ready' ? (
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#C0FF00] hover:bg-[#a6dc00] text-black font-display font-black italic uppercase tracking-wider text-sm rounded-2xl transition-all shadow-[0_0_25px_rgba(192,255,0,0.25)] cursor-pointer"
              >
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-4 bg-emerald-400 hover:bg-emerald-300 text-black font-display font-black italic uppercase tracking-wider text-sm rounded-2xl transition-all shadow-[0_0_25px_rgba(52,211,153,0.35)] cursor-pointer"
              >
