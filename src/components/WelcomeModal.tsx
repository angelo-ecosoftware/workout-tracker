    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-in fade-in duration-200">
      <div className="bg-[#111] border border-[#222] rounded-[28px] max-w-lg w-full p-6 sm:p-8 shadow-2xl relative overflow-hidden text-left">
        ...
        <div>
          ...
          <button
            onClick={onClose}
            className="w-full py-4 px-6 rounded-2xl bg-[#C0FF00] hover:bg-[#a6dc00] text-black font-display font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 active:scale-[0.99] transition-all shadow-[0_0_20px_rgba(192,255,0,0.2)] cursor-pointer"
          >
