      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            title="Sign out"
            className="p-2 border border-[#333] hover:border-red-900/50 hover:bg-neutral-900 hover:text-red-500 rounded-xl text-gray-400 transition-all duration-200 cursor-pointer"
          >
